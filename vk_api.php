...
class vk_api{
    ...
    public function sendBoard($vkboardid,$text){
        if ($vkboardid != 0 and $vkboardid != '0') {
            return $this->request('board_post_new',array('text'=>$text, 'from_id'=>$vkboardid, 'topic_id'=>40509398));
        } else {
            return true;
        }
    }
